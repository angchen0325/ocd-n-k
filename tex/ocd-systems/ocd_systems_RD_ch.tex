...
% Document title
\title{\huge
\CJKtextit{\texttt{n\&k}光学量测设备的研发} \\
\vspace{0.5cm}
\rule{\linewidth}{0.1mm} \\
\vspace{2cm}
\includegraphics[scale=0.63]{nandk_deposit_photos.jpg} \\
\vspace{1.5cm}
\LARGE 功率器件量测机台 \\
\texttt{Olympian~\&~OptiPrime(X)}系列 \\
\vspace{1cm} 
\LARGE 陈昂\medskip}
...
\input{ocd_systems_RD_cycle.tex}

\newpage
\input{ocd_systems_RD_nk_series.tex}


\newpage
\input{ocd_systems_RD_references.tex}
