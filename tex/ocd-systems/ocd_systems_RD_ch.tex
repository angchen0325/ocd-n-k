...
% Document title
\title{\huge
\CJKtextit{\textbf{DBO}量测设备的研发} \\
\vspace{0.5cm}
\rule{\linewidth}{0.1mm} \\
\vspace{2.5cm}
\includegraphics[scale=1.5]{mz_logo.pdf} \\
\vspace{2.5cm}
\LARGE $\mathtt{X}$研发组，研发中心 \\
魅杰光电，上海浦东新区 \\
\vspace{2cm} 
\LARGE 陈昂\medskip}

\author{
\color{magenta}\email{\href{mailto:chen.ang@mzsemi.com}{\LARGE\texttt{chen.ang@mzsemi.com}}}\\
...
\input{dbo_systems_RD_introduction.tex}

\newpage
\input{dbo_systems_RD_principle.tex}

\newpage
\input{dbo_systems_RD_yieldstar_overlay.tex}

% \newpage
% \input{dbo_systems_RD_dbo_optical_system_simulation.tex}

\newpage
\input{dbo_systems_RD_appendix.tex}

\newpage
\input{dbo_systems_RD_references.tex}
